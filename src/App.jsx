    ...
    >
      ...
      {menuOpen && (
        ...
        >
          ...
          <a
            href="/articles/"
            style={{ fontSize: '0.95rem', letterSpacing: '0.12em', textTransform: 'uppercase', fontWeight: 500, color: 'var(--forest)', padding: '6px 0' }}
          >
            Insights
          </a>
          <button
    ...
    >
      ...
      >
        ...
        >
          ...
          at a clear fixed fee agreed in writing before any work begins. An affordable alternative to costly
          attorney fees.
        </p>
        <div
          style={{
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
        ...
        >
          ...
          <div>
            ...
            <a href="/articles/" style={{ display: 'block', color: 'rgba(247,243,236,0.7)', padding: '6px 0', fontSize: '0.92rem' }}>
              Insights & articles
            </a>
